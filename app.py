...
<h1 style='margin:0; font-size: 3rem; text-shadow:2px 2px 10px black; line-height: 1.2;'>🎁 Tady máš svůj vánoční dárek! ❤️</h1>
<p style='font-size: 1.5rem; text-shadow:1px 1px 6px black; margin: 30px 0;'>Klikni a rozbal si ho, beruško 🎄✨</p>
